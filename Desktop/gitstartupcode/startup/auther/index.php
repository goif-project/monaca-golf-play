...
$css = '
  ...
  <link rel="stylesheet" href="'.$level.'css/auther.css" type="text/css" />
';
...
<ol class="pankuzu">
  ...
  <li><a class="underline" href="../member/">運営メンバー</a></li>
  <li><a class="underline" href="./">Masaki Wakamedaのアーカイブ</a></li>
</ol>
<div class="page-wrap cfx">
  <article>
    <h1 class="archive">投稿者：<a class="underline" href="#">Masaki Wakameda</a>のアーカイブ</h1>
    <div class="report-profile cfx">
      ...
      <div class="text-wrap flL">
        ...
        <p class="auther-sns">
          <a class="twitter opa6" href="https://twitter.com/wakamesun2" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i><span>Twitter</span></a><a class="facebook opa6" href="https://www.facebook.com/masaki.wakameda" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i><span>Facebook</span></a>
        </p>
      </div>
    </div>
    <h2 class="auther-report-list">Masaki Wakamedaの記事一覧</h2>
    <!--サブコンテンツ01-->
